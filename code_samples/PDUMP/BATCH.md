...
4. Brief inputs and outputs of the program:
    - PDUMP IS A GENERAL PURPOSE PRINT UTILITY. THE INPUT DATA SET TO BE LISTED MAY BE SEQUENTIAL, INDEXED, REGIONAL OR VSAM. MAIN PL/1 PROGRAM FOR BATCH VERSION
    - Program compilation: [BATCH.txt](BATCH.txt)
5. Expected instructions to be highlighted / supported by LSP:
    - see [BATCH.png](BATCH.png)
