...
4. Brief inputs and outputs of the program:
    - PDUMP IS A GENERAL PURPOSE PRINT UTILITY. THE INPUT DATA SET TO BE LISTED MAY BE SEQUENTIAL, INDEXED, REGIONAL OR VSAM. 3270 FULLSCREEN SUPPORT PACKAGE
    - Program compilation: [IO3270.txt](IO3270.txt)
5. Expected instructions to be highlighted / supported by LSP:
    - see [IO3270.png](IO3270.png)
