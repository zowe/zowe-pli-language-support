...
export const XDECLARE = createToken({
    name: 'XDECLARE',
    pattern: /XDECLARE/i,
    categories: [ID],
    longer_alt: ID
...
export const ALLOC = createToken({
    name: 'ALLOC',
    pattern: /ALLOC/i,
    categories: [ID],
    longer_alt: ID
...
export const PIC = createToken({
    name: 'PIC',
    pattern: /PIC/i,
    categories: [ID],
    longer_alt: ID
});
export const DIM = createToken({
    name: 'DIM',
    pattern: /DIM/i,
    categories: [ID],
    longer_alt: ID
});
export const ENV = createToken({
    name: 'ENV',
    pattern: /ENV/i,
    categories: [ID],
    longer_alt: ID
