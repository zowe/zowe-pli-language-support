...
describe("Compilation Unit Tests", () => {
    ...
    test('Create with config', () => {
        ...
        // register configs
        expect(PluginConfigurationProviderInstance.hasRegisteredProgramConfigs()).toBe(false);
        ...
        expect(PluginConfigurationProviderInstance.hasRegisteredProgramConfigs()).toBe(true);

        const config = PluginConfigurationProviderInstance.getProgramConfig(uriEntry.toString());
