...
import { lexerErrorsToDiagnostics, linkingErrorsToDiagnostics, parserErrorsToDiagnostics } from "../validation/validator";
...
export function parse(sourceFile: SourceFile): PliProgram {
    ...
    sourceFile.ast = ast;
    sourceFile.diagnostics.parser = parserErrorsToDiagnostics(PliParserInstance.errors);
    return ast;
}
...
export function link(sourceFile: SourceFile): ReferencesCache {
    ...
    sourceFile.diagnostics.linking = linkingErrorsToDiagnostics(sourceFile.references);
