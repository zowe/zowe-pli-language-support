...
/**
 * This token is used as a marker for the normal PLI parser
 * after the preprocessor found a host variable reference in an EXEC SQL statement.
 *
 * This token cannot be emitted by the tokenizer,
 * but it is generated by the preprocessor interpreter.
 */
export const EXEC_VARIABLE_MARKER = createToken({
  name: "EXEC_VARIABLE_MARKER",
  pattern: Lexer.NA,
});
