...
import { AccessMode, Alignment, AlignmentType, Assignability, AttributeKind, AttributeTypes, AttributeWitness, AttributeWitnesses, Base, BufferMode, DataType, DataTypesArray, DataTypesByAttributeKind, Endianess, FileUsage, FloatFormat, Implications, NumberMode, ParameterPassDirection, ParameterPassMode, Precisions, ScaleMode, Scope, ScopeType, Sign, StorageClass, StorageConnection, StringFormat, StringKind, TransmissionDirection, Volatility } from "./descriptions";
