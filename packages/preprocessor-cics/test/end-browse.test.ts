...
describe("CICS ENDBROWSE", () => {
  ...
  test("Missing browse type", () => {
    const { diagnostics } = cicsPreprocessor.parse("ENDBROWSE BROWSETOKEN(1)");
    expect(diagnostics).toHaveLength(1);
