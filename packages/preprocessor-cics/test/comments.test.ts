...
describe("CICS Comments", () => {
  test("PL/I multiline comment in PL/I setup", () => {
  ...
  test("PL/I line comment in PL/I setup", () => {
    const preprocessor = new CICSPreprocessor(HostLanguageType.PLI);
    const { diagnostics } = preprocessor.parse(
  ...
  test("COBOL comment in PL/I setup", () => {
    const preprocessor = new CICSPreprocessor(HostLanguageType.PLI);
    const { diagnostics } = preprocessor.parse(
  ...
  test("PL/I multiline comment in COBOL setup", () => {
  ...
  test("PL/I line comment in COBOL setup", () => {
    const preprocessor = new CICSPreprocessor(HostLanguageType.COBOL);
    const { diagnostics } = preprocessor.parse(
      "ABEND ABCODE(12) // This is a PL/I comment",
    );
  ...
  test("COBOL comment in COBOL setup", () => {
    const preprocessor = new CICSPreprocessor(HostLanguageType.COBOL);
    const { diagnostics } = preprocessor.parse(
      "ABEND ABCODE(12) *> This is a COBOL comment",
    );
