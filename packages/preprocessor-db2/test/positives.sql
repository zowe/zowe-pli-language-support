...
---
FETCH ROWSET STARTING AT ABSOLUTE -1
FROM C1 FOR 5 ROWS INTO DESCRIPTOR :LENA;
---
FETCH CUR1 USING DESCRIPTOR :SQLDA_PTR;
---
ALTER function REVERSE All VERSIONS
CONCENTRATE STATEMENTS
ACCELERATION WAITFORDATA 30.0;
---
ALTER PROCEDURE UPDATE_SALARY_1
alter ACTIVE version 
NOT DETERMINISTIC 
ACCELERATION WAITFORDATA 1.0;
---
ALTER TABLESPACE DSN8D12A.DSN8S12D
BUFFERPOOL bp1
DSSIZE 1 g
...
:datoken2    = DB2_ORDINAL_TOKEN_22,
:datoken3    = DB2_ORDINAL_TOKEN_71,
:datoken4    = DB2_ORDINAL_TOKEN_99,
:datoken5    = DB2_ORDINAL_TOKEN_100,
