...
@lexer::members {
    private commaCharAllowed = false;

    setSQLDecimalCommaAllowed(value: boolean) {
        this.commaCharAllowed = value;
    }
}
channels{COMMENTS}

SINGLEQUOTED_CURRENT: SINGLEQUOTE CURRENT SINGLEQUOTE;
SINGLEQUOTED_PREVIOUS: SINGLEQUOTE PREVIOUS SINGLEQUOTE;
SINGLEQUOTED_ORIGINAL: SINGLEQUOTE ORIGINAL SINGLEQUOTE;
SINGLEQUOTED_INVALID: SINGLEQUOTE INVALID SINGLEQUOTE;
...
DB2_ORDINAL_TOKEN_N : D B '2' UNDERSCORECHAR O R D I N A L UNDERSCORECHAR T O K E N UNDERSCORECHAR DIGIT+;
...
V10R1: V '1' '0' R '1';
V11R1: V '1' '1' R '1';
V12R1: V DIGIT DIGIT R DIGIT (M DIGIT DIGIT DIGIT)?;
...
NUMERICLITERAL : (PLUSCHAR | MINUSCHAR)?
    (
        ...
        (
            ...
            |
            COMMACHAR { this.commaCharAllowed }?
            (
